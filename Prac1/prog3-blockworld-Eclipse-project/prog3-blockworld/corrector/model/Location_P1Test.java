...
public class Location_P1Test {
    ...
    public final void testGetters_3() {
        ...
        assertEquals (Location.UPPER_Y_VALUE,auxloc.getY(),0.0);
    ...
    public final void testGetters_4() {
        ...
        assertEquals (0.0,auxloc.getY(),0.0);
    }
    ...
    public final void testSettersIncorrectY_2() {
    	...
    	assertEquals("setY",Location.UPPER_Y_VALUE,le.getY(),0.01);
    ...
    public final void testConstructor_2() {
        ...
        assertEquals("getY", Location.UPPER_Y_VALUE, lyy.getY(),0.01);
    ...
    public final void testAdd_Y_OutOfRange() {
        // fail("Test adding 'le' to location [3.3,Location.UPPER_Y_VALUE,1.1] in the same world");
      	...
      	Location lieee = new Location(earth,3.3,Location.UPPER_Y_VALUE,1.1);
        Location loc = lieee.add(le);    	// NEW
        assertSame("getWorld", earth, lieee.getWorld());
        assertEquals("getX", 4.4, lieee.getX(),0.01); 
        assertEquals("getY", Location.UPPER_Y_VALUE, lieee.getY(),0.01);
        assertEquals("getZ", 4.4, lieee.getZ(),0.01);

        // SUMAS ENCADENADAS
        // Esta prueba no tiene sentido. Realmente está probando si add() devuelve this,
        // que ya se ha hecho antes.
        /*
        lieee.add(loc).add(le);
        assertEquals("(liee+auxloc+le).getX()=9.9" , 9.9,lieee.getX(),0.01);
        assertEquals("(liee+auxloc+le).getY()=UPPER_Y_VALUE" ,255.0, lieee.getY(),0.01);
        assertEquals("(liee+auxloc+le).getZ()=12.1",12.1, lieee.getZ(),0.01);
        */
    }
