...
@Test
 public void testUseItemAgainstAnimal() {
	try {
		...
		System.out.println(world10x10.getNeighbourhoodString(player.getLocation()));
		bw.orientatePlayer(player, 0, 1, 0);
		bw.useItem(player, 10);
		assertNotNull(world10x10.getCreatureAt(player.getOrientation()));
		bw.useItem(player, 10);
		assertEquals(is,world10x10.getItemsAt(player.getOrientation()));
		assertNull(world10x10.getCreatureAt(player.getOrientation()));
...
public void testUseItemAgainstBlock2() {
	try {
		...
		world10x10.addBlock(player.getOrientation(), block);
		bw.useItem(player, 4);
		...
		assertNotNull(world10x10.getItemsAt(player.getOrientation()));
		assertEquals(is,world10x10.getItemsAt(player.getOrientation()));
...
public void testUseItemWithMaterialBlock() {
	try {
		...
		assertEquals(is,player.getInventory().getItem(0));
		bw.orientatePlayer(player, 0, 0, -1);
		bw.selectItem(player, 0);
		assertEquals(is,player.getInventory().getItemInHand());
		assertNull(world10x10.getBlockAt(player.getOrientation()));
		bw.useItem(player, 2);
...
public void testUseItemSolidBlockAgainstBlock() {
	...
	try {
		...
		bw.selectItem(player, 0);
		bw.useItem(player, 5);
		assertNotNull(world10x10.getBlockAt(new Location(world10x10,0,64,-1)));
		bw.useItem(player, 7);
		assertNull(world10x10.getBlockAt(new Location(world10x10,0,64,-1)));
		bw.useItem(player, 2);
		assertNotNull(world10x10.getBlockAt(new Location(world10x10,0,64,-1)));
...
public void testPlayFileException() throws FileNotFoundException {
	bw.playFile("pretest/files/NoFileExist.txt");
}
