...
public void testAddBlocksAndGetBlock2() {	
	try {
		...
		assertEquals(63,world10x10.getHighestLocationAt(loc).getY(),0.01);
		world10x10.addBlock(new Location(world10x10,-1,64,1), bs);
		assertNull(world10x10.getCreatureAt(loc));
		assertEquals(64,world10x10.getHighestLocationAt(loc).getY(),0.01);
	} catch (Exception e) {
		fail("Error: no debió lanzar la excepción "+e.getClass().toString());
	}
}
...
try {
	...
	//Comprobamos que no hay nada
		//fail("comprueba que no hay nada");
...
public void testAddBlocksAndGetBlock5() {
	try {	
		Location locplayer = world10x10.getPlayer().getLocation();
		System.out.println(locplayer);
		double y = world10x10.getHighestLocationAt(locplayer).getY();
		Location locbloq = new Location(world10x10, locplayer.getX(), y+1, locplayer.getZ());
		System.out.println(locbloq);
		//System.out.println(y);
		world10x10.addBlock(locbloq, bl);
		assertEquals(65, world10x10.getHighestLocationAt(locbloq).getY(),0.01);
...
public void testAddBlocksAndGetBlockOutOfWorldException() throws BadLocationException, EntityIsDeadException {
		...
		world10x10.addBlock(player.getOrientation(), bl);
}	
...
public void testGetNeighbourhoodString1() {
	...
	try {
		compareLines(NEIGHBOURHOOD1, world10x10.getNeighbourhoodString(locplayer));
	} catch(Exception e) {
		fail("Error: no debió lanzar la excepción "+e.getClass().toString());
	}
}
...
public void testIsFreeTrue1() {
	Set<Location> adyacentes = world10x10.getPlayer().getLocation().getNeighborhood();
	
	for(Location i : adyacentes) {
		try {
			if(world10x10.getBlockAt(i) == null && world10x10.getCreatureAt(i) == null && world10x10.getItemsAt(i) == null) {
				assertTrue(world10x10.isFree(i));
			}
			else {
				assertFalse(world10x10.isFree(i));
			}
		} catch (BadLocationException e) {
...
public void testIsFreeTrue2() {
	try {
		assertTrue(world10x10.isFree(new Location(world10x10,-3,67,-2)));
		assertTrue(world10x10.isFree(new Location(world10x10,-1,67,-3)));
		assertTrue(world10x10.isFree(new Location(world10x10,-1,63,4)));
		assertTrue(world10x10.isFree(new Location(world10x10,0,63,4)));
		assertTrue(world10x10.isFree(new Location(world10x10,4,63,4)));
		assertTrue(world10x10.isFree(new Location(world10x10,4,66,-4)));
		assertTrue(world10x10.isFree(new Location(world10x10,-4,62,5)));
		assertTrue(world10x10.isFree(new Location(world10x10,4,64,3)));
	} catch (Exception e) {
		fail("Error: no debió lanzar la excepción "+e.getClass().toString());
	}
}
...
public void testIsFreeTrue3() {
	try {		
		...
		//Comprobamos en items con bloques de agua
		 assertTrue(world10x10.isFree(new Location(world10x10,world10x10.getPlayer().getLocation().getX() - 1, world10x10.getPlayer().getLocation().getY()+1, world10x10.getPlayer().getLocation().getZ()-1)));
		 assertTrue(world10x10.isFree(new Location(world10x10,world10x10.getPlayer().getLocation().getX() - 1, world10x10.getPlayer().getLocation().getY()+1, world10x10.getPlayer().getLocation().getZ())));
		 assertTrue(world10x10.isFree(new Location(world10x10,world10x10.getPlayer().getLocation().getX() - 1, world10x10.getPlayer().getLocation().getY()+1, world10x10.getPlayer().getLocation().getZ()+1)));


		 //Comprobamos en items con bloques de lava
		 assertTrue(world10x10.isFree(new Location(world10x10,world10x10.getPlayer().getLocation().getX(), world10x10.getPlayer().getLocation().getY()+1, world10x10.getPlayer().getLocation().getZ()-1)));
		 assertTrue(world10x10.isFree(new Location(world10x10,world10x10.getPlayer().getLocation().getX(), world10x10.getPlayer().getLocation().getY()+1, world10x10.getPlayer().getLocation().getZ())));
		 assertTrue(world10x10.isFree(new Location(world10x10,world10x10.getPlayer().getLocation().getX(), world10x10.getPlayer().getLocation().getY()+1, world10x10.getPlayer().getLocation().getZ()+1)));
		 
		 assertFalse(world10x10.isFree(world10x10.getPlayer().getLocation()));
	} catch (Exception e) {
			fail("Error: no debió lanzar la excepción "+e.getClass().toString());
	}
}
...
public void testIsFreeFalse3() {
	...
	Monster m1 = new Monster(new Location(world10x10,1,63,4),2);
	Animal a1 = new Animal(new Location(world10x10,-1, 66, -4), 20);
	
	try {
		assertFalse(world10x10.isFree(m1.getLocation()));
		assertFalse(world10x10.isFree(a1.getLocation()));
	} catch (BadLocationException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
...
public void testAddCreature2() {
	...
	try {
		...
		Creature creature = new Monster(loc,20);
		world10x10.addCreature(creature);
...
public void testAddCreature3() {
	...
	try {
		loc = new Location(world10x10,1,66,-1);
		Block lava = new LiquidBlock(Material.LAVA);
		world10x10.addBlock(loc, lava);
		
		Creature animal = new Animal(loc, 20);
...
public void testAddCreature4() {
	...
	try {
		...
		Creature c = new Monster(loc, 20);
		world10x10.addCreature(c);
		assertNull(world10x10.getItemsAt(loc));
		assertNotNull(world10x10.getCreatureAt(loc));
	} catch (Exception e) {
		fail("Error: no debió lanzar la excepción "+e.getClass().toString());
...
public void testAddCreatureException2() throws BadLocationException {
	Location loc = new Location(world10x10,-1,64,0);
	Creature animal = new Animal(loc,20);
	world10x10.addCreature(animal);
}	
...
public void testAddCreatureException3() throws BadLocationException {
	...
	Creature creature = new Animal(new Location(world10x10,-1,64,1),15);
...
public void testAddItems2() {
	try {
		Location loc = new Location(world10x10,4,63,4);
		ItemStack i1 = new ItemStack(Material.APPLE,2);
		ItemStack espada = new ItemStack(Material.IRON_SWORD,1);
		assertEquals(espada,world10x10.getItemsAt(loc));
		world10x10.addItems(loc, i1);
		assertEquals(i1, world10x10.getItemsAt(loc));
 ...
 * y se comprueba que salta la excepción BadLocationException en ambos casos */
@Test(expected=BadLocationException.class)
public void testAddItemsException2() throws BadLocationException {
	Location loc = new Location(world10x10, -1, 65, 0);
	ItemStack item;
	Creature monster = new Monster(loc,20);
	try {
		world10x10.addCreature(monster);
		item = new ItemStack(Material.APPLE,3);
		world10x10.addItems(loc, item);
	} catch (StackSizeException e) {
		// TODO Auto-generated catch block
...
public void testAddItemOutOfWorldException() throws BadLocationException, EntityIsDeadException   {
	Player player = world10x10.getPlayer();
	while(player.getLocation().getY() != Location.UPPER_Y_VALUE) {
		player.move(0, 1, 0);
	}
	player.orientate(0, 1, 0);
	ItemStack i1;
	try {
		i1 = new ItemStack(Material.APPLE,2);
		world10x10.addItems(player.getOrientation(), i1);
	} catch (StackSizeException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
...
public void testDestroyBlockAt2() {
	try {
		...
		ItemStack i1 = new ItemStack(Material.BREAD,5);
		b1.setDrops(Material.BREAD,5);
		world10x10.addBlock(loc, b1);
		assertEquals(66, world10x10.getHighestLocationAt(loc).getY(),0.01);
		world10x10.destroyBlockAt(loc);
		assertEquals(65, world10x10.getHighestLocationAt(loc).getY(),0.01);
		assertEquals(i1, world10x10.getItemsAt(loc));
...
public void testDestroyBlockAtException2() throws BadLocationException {
	...
	Location loc = new Location(world10x10,12,55,20);
	world10x10.destroyBlockAt(loc);
}
...
public void testKillCreature2() {
	try {
	    ...
	    world10x10.killCreature(new Location(world10x10, 0, 66, -1));
	    assertNull(world10x10.getCreatureAt(new Location(world10x10, 0, 66, -1)));
	    
	    world10x10.killCreature(new Location(world10x10, 0, 66, 0));
	    assertNull(world10x10.getCreatureAt(new Location(world10x10, 0, 66, 0)));
...
public void testKillCreatureException() throws BadLocationException  {
	world10x10.killCreature(new Location(world10x10, 3, 66, 1));
}	
