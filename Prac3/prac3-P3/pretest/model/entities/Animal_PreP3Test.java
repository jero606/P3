...
public void testLivingEntity() {
	...
	Animal a1 = new Animal(loc,LivingEntity.MAX_HEALTH);
	creature = a1;
	assertEquals(creature, liv);
}
...
public void testToString() {
	...
	Animal a1 = new Animal(new Location(world, 10, 20.5, -3.2), -0.25);
	assertEquals(outM2, a1.toString().trim());
}
