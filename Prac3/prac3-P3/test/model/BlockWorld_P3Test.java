...
public void testPlayFileEjemplo() {
        ...
        PrintStream ps=standardIO2File("test/files/testPlayFileEjemplo.alu");
        try {
                bword.playFile("test/files/testPlayFileEjemplo.txt");
        } catch (Exception e) {
                fail("Error: no debió lanzar la excepción "+e.getClass().toString());
        }
        ...
        StringBuilder sbAlu = readFromFile("test/files/testPlayFileEjemplo.alu");
        StringBuilder sbSol = readFromFile("test/files/testPlayFileEjemplo.sol");
        ...
        if (linesMatch != strSol.split("\n").length) {
                ...
                sbSol = readFromFile("test/files/testPlayFileEjemploBis.sol");
                ...
                if (linesMatch != strSol.split("\n").length) {
                        ...
                        fail("La salida no coincide:\n\ttest/files/testPlayFileEjemplo.alu != test/files/testPlayFileEjemplo.sol\n\ten línea "+(linesMatch+1));
                }
        }
}
